...
{
    public partial class recreateschemas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagAssignment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagAssignment_Entry_EntryId",
                        column: x => x.EntryId,
